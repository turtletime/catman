function createFootprint(entity) {
  ...
  footprint[Symbol.for('changed')] = () => {
    ...
    footprint.rect.beginFill(footprint.color)
  ...
  this.events.camera.on("changed", footprint[Symbol.for('changed')])
  ...
  footprint.destroy = () => {
    ...
    this.events.camera.removeListener("changed", footprint[Symbol.for('changed')])
