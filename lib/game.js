...
require('./react/level-editor.jsx')
...
class Game extends Action {
  async execute() {
    ...
    this.actions = Object.assign.apply(null, [{
      ...
      'remove-entity': require('./entity.js').remove,
      ...
      'level-editor-jsx': require('./react/level-editor.jsx')
    }].concat([
    ...
    await this.invoke('init-graphics', _gameWidth, _gameHeight)
