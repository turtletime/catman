module.exports = class extends Action {
  async execute(entity) {
    ...
    const onChanged = () => {
      ...
      footprint.rect.x = this.state.scene.camera.toScreenX(footprint.entity.x - footprint.entity.size.w / 2)
      footprint.rect.y = this.state.scene.camera.toScreenY(footprint.entity.y - footprint.entity.size.h / 2)
