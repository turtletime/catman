...
module.exports = class extends Action {
  async execute(entity) {
    ...
    sprite.framesForDirection = sprite.animation.frames[Symbol.keyFor(getDirection(entity.dx, entity.dy))]
    ...
    sprite.onChanged = () => {
      ...
      const facing = getDirection(sprite.entity.dx, sprite.entity.dy)
