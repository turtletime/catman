module.exports = class extends Action {
  async execute() {
    ...
    scene.camera.toScreenX = (x) => (x + scene.camera.x) * scene.camera.zoom + this.state.graphics.dimensions.x / 2
    scene.camera.toScreenY = (y) => (y + scene.camera.y) * scene.camera.zoom + this.state.graphics.dimensions.y / 2
